...
describe('Tab component', () => {
	test('renders three tabs', () => {
		...
		// Arrange
		render(<Tab items={[{ text: FirstTab, hide: false, tabKey: ActiveTab.ImpactGraph }, { text: SecondTab, hide: false, tabKey: ActiveTab.ImpactGraph }, { text: ThirdTab, hide: false, tabKey: ActiveTab.ImpactGraph }]} activeTab={ActiveTab.ImpactGraph} onChangeMenu={i => i}/>)
		// Assert
	...
	test('renders two tabs and hides the third', () => {
		...
		const ThirdTab = 'Third-Tab'
		// Arrange
		render(<Tab items={[{ text: FirstTab, hide: false, tabKey: ActiveTab.ImpactGraph }, { text: SecondTab, hide: true, tabKey: ActiveTab.ImpactGraph }, { text: ThirdTab, hide: false, tabKey: ActiveTab.ImpactGraph }]} activeTab={ActiveTab.ImpactGraph} onChangeMenu={i => i}/>)
		// Assert
